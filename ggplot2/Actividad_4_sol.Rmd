...
ggplot(data = mpg) + geom_bar(aes(x = drv, fill = drv)) + labs(x = "Tracción", y = "Frecuencia" , fill = "Tracción") + scale_fill_brewer(palette = "Dark2", labels = c('4' = '4x4', 'f' = 'Delantera', 'r' = 'Trasera')) +
